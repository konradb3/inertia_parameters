...
opt = optimset(optimset('fmincon'), 'MaxFunEvals', 100000, 'MaxIter', 100);
opt.Algorithm = 'interior-point';
[q0, fval] = fmincon(cost2, joints_rand(5, lwrs),[], [], [], [], repmat(lwrs.qlim(:,1), 5, 1), repmat(lwrs.qlim(:,2), 5, 1), [], opt);
